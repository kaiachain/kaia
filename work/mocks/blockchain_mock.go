...
// Source: github.com/kaiachain/kaia/work (interfaces: BlockChain)
...
func (m *MockBlockChain) GetBlobSidecar(arg0 common.Hash) *types.BlobTxSidecar {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBlobSidecar", arg0)
	ret0, _ := ret[0].(*types.BlobTxSidecar)
	return ret0
}

// GetBlobSidecar indicates an expected call of GetBlobSidecar.
func (mr *MockBlockChainMockRecorder) GetBlobSidecar(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBlobSidecar", reflect.TypeOf((*MockBlockChain)(nil).GetBlobSidecar), arg0)
}
