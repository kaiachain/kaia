...
const (
	...
	ErrorInvalidValue
	ErrorFatal
	// TODO-Kaia-Node fix the configuration to filter wrong input flags before the klay server is launched
...
var flagsWithValues = []struct {
	...
	// TODO-Kaia-Node the flag is not defined on any klay binaries
	//{
	//	flag:     "--networktype",
