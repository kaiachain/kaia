...
{{- if eq .NodeType "cn" }}
        echo 'RPC_API="db,eth,klay,net,governance,web3,miner,personal,txpool,debug,admin,istanbul,mainbridge,subbridge,auction"' >> /klaytn-docker-pkg/conf/k{{ .NodeType }}d.conf
{{- else }}
