...
import (
	...
	"github.com/kaiachain/kaia/v2/consensus/istanbul/backend"
...
//go:generate mockgen -destination=./peer_set_mock_test.go -package=cn github.com/kaiachain/kaia/v2/node/cn PeerSet
