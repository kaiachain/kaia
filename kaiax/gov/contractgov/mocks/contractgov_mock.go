...
// Source: github.com/kaiachain/kaia/kaiax/gov/contractgov/types (interfaces: ContractGovModule)
...
import (
	...
	types "github.com/kaiachain/kaia/kaiax/gov/types"
)
...
func (m *MockContractGovModule) EffectiveParamsPartial(arg0 uint64) (map[types.ParamEnum]interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EffectiveParamsPartial", arg0)
	ret0, _ := ret[0].(map[types.ParamEnum]interface{})
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
