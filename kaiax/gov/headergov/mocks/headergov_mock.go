...
// Source: github.com/kaiachain/kaia/kaiax/gov/headergov/types (interfaces: HeaderGovModule)
...
import (
	...
	types0 "github.com/kaiachain/kaia/kaiax/gov/types"
...
func (m *MockHeaderGovModule) EffectiveParamsPartial(arg0 uint64) (map[types0.ParamEnum]interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EffectiveParamsPartial", arg0)
	ret0, _ := ret[0].(map[types0.ParamEnum]interface{})
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
