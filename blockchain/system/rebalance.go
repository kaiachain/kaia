...
func (result *kip103result) fillRetired(contract *rebalance.TreasuryRebalanceCaller, state *state.StateDB) error {
...
func (result *kip103result) fillNewbie(contract *rebalance.TreasuryRebalanceCaller) error {
