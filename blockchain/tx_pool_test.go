...
func setupTxPoolWithConfig(config *params.ChainConfig) (*TxPool, *ecdsa.PrivateKey) {
	...
	pool := NewTxPool(testTxPoolConfig, config, blockchain, &dummyGovModule{chainConfig: config}, []kaiax.TxPoolModule{})
...
func TestStateChangeDuringTransactionPoolReset(t *testing.T) {
	...
	pool := NewTxPool(testTxPoolConfig, params.TestChainConfig, blockchain, &dummyGovModule{chainConfig: params.TestChainConfig}, []kaiax.TxPoolModule{})
	defer pool.Stop()
...
func testTransactionQueueGlobalLimiting(t *testing.T, nolocals bool) {
	...
	pool := NewTxPool(config, params.TestChainConfig, blockchain, &dummyGovModule{chainConfig: params.TestChainConfig}, []kaiax.TxPoolModule{})
	defer pool.Stop()
