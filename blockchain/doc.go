...
A Kaia node starts to generate a chain from a genesis block and appends validated blocks transferred from other nodes or generated by the node.
...
As well as the exact transaction process, Kaia achieved the efficiency of the transaction processing through a caching logic.
