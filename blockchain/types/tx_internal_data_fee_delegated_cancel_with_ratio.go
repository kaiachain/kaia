...
func (t *TxInternalDataFeeDelegatedCancelWithRatio) IntrinsicGas(currentBlockNumber uint64) (uint64, uint64, error) {
	return params.TxGasCancel + params.TxGasFeeDelegatedWithRatio, 0, nil
}
