...
func (t *TxInternalDataFeeDelegatedValueTransfer) IntrinsicGas(currentBlockNumber uint64) (uint64, uint64, error) {
	return params.TxGasValueTransfer + params.TxGasFeeDelegated, 0, nil
}
