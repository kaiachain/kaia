...
// TxInternalDataValueTransfer represents a transaction transferring KAIA.
...
func (t *TxInternalDataValueTransfer) Validate(stateDB StateDB, currentBlockNumber uint64, checkMutableValue bool) error {
