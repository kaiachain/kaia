...
func TestPragueSigning(t *testing.T) {
	...
	authorizationList := []Authorization{{ChainID: uint64(10), Address: common.HexToAddress("0x0000000000000000000000000000000000000001"), Nonce: nonce, V: uint8(0), R: big.NewInt(0), S: big.NewInt(0)}}
