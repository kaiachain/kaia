...
// nodeAtDist creates a unique node at the given distance from testSelf.
...
// fillBucket fills a bucket with nodes at the given distance, bypassing the IP limit.
func fillBucket(b *bucket, ld int) {
