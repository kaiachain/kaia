...
func (ec *KaiaClient) BridgeAddPeerOnBridge(ctx context.Context, url string) (bool, error) {
	var result bool
...
func (ec *KaiaClient) BridgeRemovePeerOnBridge(ctx context.Context, url string) (bool, error) {
	var result bool
...
func (ec *KaiaClient) BridgePeersOnBridge(ctx context.Context) ([]*p2p.PeerInfo, error) {
...
func (ec *KaiaClient) BridgeNodeInfo(ctx context.Context) (*p2p.NodeInfo, error) {
...
// BridgePeersOnBridge returns the peer list of bridge node for service chain.
func (ec *KaiaClient) MainBridgePeersOnBridge(ctx context.Context) ([]*p2p.PeerInfo, error) {
	var result []*p2p.PeerInfo
...
// BridgeNodeInfo returns the node information
func (ec *KaiaClient) MainBridgeNodeInfo(ctx context.Context) (*p2p.NodeInfo, error) {
	var result p2p.NodeInfo
...
func (ec *KaiaClient) BridgeGetChildChainIndexingEnabled(ctx context.Context) (bool, error) {
	var result bool
...
func (ec *KaiaClient) BridgeConvertChildChainBlockHashToParentChainTxHash(ctx context.Context, scBlockHash common.Hash) (common.Hash, error) {
...
func (ec *KaiaClient) BridgeConvertRequestTxHashToHandleTxHash(ctx context.Context, requestTxHash common.Hash) (common.Hash, error) {
...
func (ec *KaiaClient) BridgeGetReceiptFromParentChain(ctx context.Context, hash common.Hash) (*types.Receipt, error) {
...
func (ec *KaiaClient) BridgeGetParentOperatorAddr(ctx context.Context) (common.Address, error) {
...
func (ec *KaiaClient) BridgeGetChildOperatorAddr(ctx context.Context) (common.Address, error) {
	var result common.Address
...
func (ec *KaiaClient) BridgeGetParentOperatorNonce(ctx context.Context) (uint64, error) {
	var result uint64
...
func (ec *KaiaClient) BridgeGetLatestAnchoredBlockNumber(ctx context.Context) (uint64, error) {
	var result uint64
...
func (ec *KaiaClient) BridgeEnableAnchoring(ctx context.Context) (bool, error) {
	return ec.setAnchoring(ctx, true)
}

// BridgeDisableAnchoring can disable anchoring function and return the set value.
func (ec *KaiaClient) BridgeDisableAnchoring(ctx context.Context) (bool, error) {
	return ec.setAnchoring(ctx, false)
}

// setAnchoring can set if anchoring is enabled or not.
func (ec *KaiaClient) setAnchoring(ctx context.Context, enable bool) (bool, error) {
	var result bool
...
func (ec *KaiaClient) BridgeGetAnchoringPeriod(ctx context.Context) (uint64, error) {
	var result uint64
...
func (ec *KaiaClient) BridgeGetSentChainTxsLimit(ctx context.Context) (uint64, error) {
	var result uint64
...
func (ec *KaiaClient) BridgeGetRegisteredOperators(ctx context.Context, bridge common.Address) ([]common.Address, error) {
	var result []common.Address
...
func (ec *KaiaClient) BridgeSetValueTransferOperatorThreshold(ctx context.Context, bridge common.Address, threshold uint8) (common.Hash, error) {
	var result common.Hash
...
func (ec *KaiaClient) BridgeGetValueTransferOperatorThreshold(ctx context.Context, bridge common.Address) (uint8, error) {
	var result uint8
...
func (ec *KaiaClient) BridgeDeployBridge(ctx context.Context) (common.Address, common.Address, error) {
	var result []common.Address
...
func (ec *KaiaClient) BridgeRegisterBridge(ctx context.Context, cBridge common.Address, pBridge common.Address) error {
...
func (ec *KaiaClient) BridgeDeregisterBridge(ctx context.Context, cBridge common.Address, pBridge common.Address) error {
...
func (ec *KaiaClient) BridgeListBridge(ctx context.Context) ([]*BridgeJournal, error) {
...
func (ec *KaiaClient) BridgeSubscribeBridge(ctx context.Context, cBridge common.Address, pBridge common.Address) error {
...
func (ec *KaiaClient) BridgeUnsubscribeBridge(ctx context.Context, cBridge common.Address, pBridge common.Address) error {
...
func (ec *KaiaClient) BridgeRegisterTokenContract(ctx context.Context, cBridge, pBridge, cToken, pToken common.Address) error {
...
// If the registering is failed, it returns an error.
func (ec *KaiaClient) BridgeDeregisterTokenContract(ctx context.Context, cBridge, pBridge, cToken, pToken common.Address) error {
...
func (ec *KaiaClient) BridgeTxPendingCount(ctx context.Context) (int, error) {
	var result int
...
func (ec *KaiaClient) BridgeGetTxPending(ctx context.Context) (map[common.Address]types.Transactions, error) {
...
func (ec *KaiaClient) BridgeSetERC20Fee(ctx context.Context, bridgeAddr, tokenAddr common.Address, fee *big.Int) (common.Hash, error) {
	var result common.Hash
...
func (ec *KaiaClient) BridgeSetKLAYFee(ctx context.Context, bridgeAddr common.Address, fee *big.Int) (common.Hash, error) {
	var result common.Hash
...
func (ec *KaiaClient) BridgeGetERC20Fee(ctx context.Context, bridgeAddr, tokenAddr common.Address) (*big.Int, error) {
...
func (ec *KaiaClient) BridgeGetKLAYFee(ctx context.Context, bridgeAddr common.Address) (*big.Int, error) {
	var result hexutil.Big
...
func (ec *KaiaClient) BridgeSetFeeReceiver(ctx context.Context, bridgeAddr, receiver common.Address) (common.Hash, error) {
	var result common.Hash
...
func (ec *KaiaClient) BridgeGetFeeReceiver(ctx context.Context, bridgeAddr common.Address) (common.Address, error) {
	var result common.Address
