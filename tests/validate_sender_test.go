...
func TestValidateSenderContract(t *testing.T) {
	...
	// solc --combined-json abi,bin,bin-runtime,hashes,metadata ../contracts/testing/validatesender/validate_sender.sol > ../contracts/testing/validatesender/validate_sender.sol.json
	start = time.Now()
	filepath := "../contracts/testing/validatesender/validate_sender.sol"
	...
	c := contracts["../contracts/testing/validatesender/validate_sender.sol:ValidateSenderContract"]
