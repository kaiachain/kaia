...
func (s *PublicBlockChainAPI) EstimateGas(ctx context.Context, args CallArgs, blockNrOrHash *rpc.BlockNumberOrHash) (hexutil.Uint64, error) {
	...
	return DoEstimateGas(ctx, s.b, args, bNrOrHash, s.b.RPCEVMTimeout(), new(big.Int).SetUint64(gasCap))
}
...
func DoEstimateGas(ctx context.Context, b Backend, args CallArgs, blockNrOrHash rpc.BlockNumberOrHash, timeout time.Duration, gasCap *big.Int) (hexutil.Uint64, error) {
	var feeCap *big.Int
