...
//go:generate ./abigenw --pkg rebalance --sol ./contracts/system_contracts/rebalance/TreasuryRebalance.sol --out ./contracts/system_contracts/rebalance/TreasuryRebalance.go --ver 0.8.19
